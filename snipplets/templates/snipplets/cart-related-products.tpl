...
{% set section_class = 'js-related-products-notification position-relative' %}
{% set title_container_class = 'row no-gutters mb-2 pb-1 align-items-center' %}
{% set title_class = 'h4 mb-0 col mr-3' %}
...
{% set slider_control_next_class = 'swiper-button-next ml-2 ' ~ slider_control_container_class %}
