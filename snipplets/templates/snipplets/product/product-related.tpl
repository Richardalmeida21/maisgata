...
{% set complementary_section_class = alternative_products ? ' pt-5' %}
{% set container_class = 'container pr-0 pr-md-0' %}
{% set title_container_class = 'row no-gutters mb-3 pb-2 align-items-center' %}
{% set title_class = 'h3 mb-1 col mr-3' %}
...
{% set slider_control_container_class = 'd-inline-block svg-circle svg-icon-text' %}
...
{% if complementary_products %}
    {{ component(
        'products-section',{
            ...
            svg_sprites: false,
            section_classes: {
                section: 'js-complementary-products ' ~ section_class ~ complementary_section_class,
                container: container_class,
                title_container: title_container_class,
                title: title_class,
