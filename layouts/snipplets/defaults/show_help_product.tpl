<div id="single-product" class="js-has-new-shipping js-product-detail js-product-container js-shipping-calculator-container pt-3 pt-md-5" data-store="product-detail">
    <div class="container">
        <div class="row section-single-product">
            <div class="col-12 col-md-8">
                <div class="row">
                    <div class="col-12 col-md-2 order-last order-md-0 pr-0 pr-md-3">
                        <div class="js-swiper-product-thumbs-demo swiper-product-thumb mb-3"> 
                            <div class="swiper-wrapper">
                                <div class="swiper-slide w-auto">
                                    <div class="product-thumb d-block position-relative mr-3 mr-md-0 mb-md-3">
                        ...
                        <div class="js-swiper-product-thumb-controls-demo text-center d-none d-md-block">
                            <div class="js-swiper-product-thumbs-prev-demo swiper-button-prev swiper-product-thumb-control d-inline-block svg-circle svg-icon-text">{% include "snipplets/svg/chevron-up.tpl" with {svg_custom_class: "icon-inline icon-lg"} %}</div>
                            <div class="js-swiper-product-thumbs-next-demo swiper-button-next swiper-product-thumb-control d-inline-block svg-circle svg-icon-text ml-2">{% include "snipplets/svg/chevron-down.tpl" with {svg_custom_class: "icon-inline icon-lg"} %}</div>
                        </div>
                    </div>
            ...
            <div class="col pt-3">
                ...
                <section class="page-header pt-2">
                    ...
                    <h2 class="h1 pt-2 mb-3">{{ "Producto de ejemplo" | translate }}</h1>
                </section>
                ...
                <div class="price-container mb-4">
                    <div class="mb-2">
                        ...
                        <div class="d-inline-block h3 price_compare_value">
...
<section id="related-products" class="section-products-related position-relative" data-store="related-products">
    <div class="container">
        <div class="row mb-3 pb-2 align-items-center">
            <div class="col">
                <h2 class="h3 mb-1">{{ "Productos relacionados" | translate }}</h2>
            </div>
        </div>
        <div class="row">
