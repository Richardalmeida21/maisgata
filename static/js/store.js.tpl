	...
	{% if template == 'home' %}
        ...
        {% if (has_featured_products_slider or has_new_products_slider or has_sale_products_slider) or theme_editor %}
            ...
            {% if has_featured_products_slider or theme_editor %}
                ...
                {% if "featured_products_image.jpg" | has_custom_image %}
                    var slidesPerViewFeaturedDesktopVal = 2;
                {% else %}
                    var slidesPerViewFeaturedDesktopVal = {% if featured_columns_desktop == 4 %}4{% elseif featured_columns_desktop == 5 %}5{% elseif featured_columns_desktop == 6 %}6{% else %}slidesPerViewDesktopVal{% endif %};
                {% endif %}
                    
                var slidesPerViewFeaturedMobileVal = {% if featured_columns_mobile == 1 %}1.15{% elseif featured_columns_mobile == 2 %}2.25{% else %}slidesPerViewMobileVal{% endif %};
            ...
            {% if has_sale_products_slider or theme_editor %}
                ...
                var slidesPerViewSaleDesktopVal = {% if sale_columns_desktop == 4 %}4{% elseif sale_columns_desktop == 5 %}5{% elseif sale_columns_desktop == 6 %}6{% else %}slidesPerViewDesktopVal{% endif %};
                var slidesPerViewSaleMobileVal = {% if sale_columns_mobile == 1 %}1.15{% elseif sale_columns_mobile == 2 %}2.25{% else %}slidesPerViewMobileVal{% endif %};
