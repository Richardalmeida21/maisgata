    ...
    {{ component(
        'promotions/cross-selling-form', {
            ...
            icon_config: {
                ...
                custom_icon_markup: include("snipplets/svg/chevron-down.tpl", { svg_custom_class: "icon-inline icon-w-12 icon-md mr-2" })
            },
            content: {
                button_placeholder: include('snipplets/placeholders/button-placeholder.tpl', { custom_class: 'mt-3 mb-0' })
            }
        })
    }}
{% endif %}