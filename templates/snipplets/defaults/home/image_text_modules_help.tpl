...
<div class="js-module-banner-placeholder">
	<div class="container p-0">
		{% for i in 1..2 %}
			<div class="textbanner mb-md-4">
				<div class="row no-gutters align-items-center">
					<div class="col-md-6 textbanner-image overlay overflow-none textbanner-image-empty textbanner-image-md">
					</div>
					<div class="col-md-6 px-3 px-md-4 textbanner-text text-center {% if loop.index is even %}order-md-first{% endif %}">
						<div class="h1 mb-0">{{ 'Módulo de imagen y texto' | translate }}</div>
