...
{% elseif section_select == 'welcome' %}
	...
	{% if show_help or (show_component_help and not has_welcome_message) %}
		{% include 'snipplets/defaults/home/welcome_message_help.tpl' with { title: 'Mensaje de bienvenida'| translate, data_store: 'home-welcome-message' }  %}
	{% else %}
...
{% elseif section_select == 'institutional' %}
	...
	{% if show_help or (show_component_help and not has_institutional_message) %}
		{% include 'snipplets/defaults/home/welcome_message_help.tpl' with { title: 'Mensaje institucional'| translate, data_store: 'home-institutional-message' }  %}
	{% else %}
...
{% elseif section_select == 'modules' %}
	...
	{#  **** Modules ****  #}
	<section class="section-banners-home position-relative" data-store="home-image-text-module">
