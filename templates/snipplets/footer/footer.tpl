							...
							<div class="{% if settings.footer_menus_toggle %}js-accordion-container accordion{% endif %} col-12 col-md">
								...
								{% endif %}
									{% if settings.footer_menu_title %}
										<div class="h4 py-3 p-md-0 mb-md-4 {% if settings.footer_menus_toggle %}col{% endif %}">{{ settings.footer_menu_title }}</div>
									{% endif %}
								{% if settings.footer_menus_toggle %}
							...
							<div class="{% if settings.footer_menus_toggle %}js-accordion-container accordion{% endif %} col-12 col-md">
								...
								{% endif %}
									{% if settings.footer_menu_secondary_title %}
										<div class="h4 py-3 p-md-0 mb-md-4 {% if settings.footer_menus_toggle %}col{% endif %}">{{ settings.footer_menu_secondary_title }}</div>
									{% endif %}
								{% if settings.footer_menus_toggle %}
										<span class="d-md-none">
											<span class="js-accordion-toggle-inactive">
							...
							<div class="{% if settings.footer_menus_toggle %}js-accordion-container accordion{% endif %} col-12 col-md mb-md-4">
								...
								{% endif %}
									{% if settings.footer_contact_title %}
										<div class="h4 py-3 p-md-0 mb-md-4 {% if settings.footer_menus_toggle %}col{% endif %}">{{ settings.footer_contact_title }}</div>
									{% endif %}
								{% if settings.footer_menus_toggle %}
										<span class="d-md-none">
											<span class="js-accordion-toggle-inactive">
